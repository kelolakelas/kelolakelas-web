...
import { descriptionText, formatPrice, getCatalogClass, scheduleDetailLabel, scheduleOptions } from '@/lib/catalog';
...
export default async function ClassDetail({ params }: { params: Promise<{ id: string }> }) {
  ...
  const item = result.data; const scheduleChoices = scheduleOptions(item.schedules); const description = descriptionText(item.description);
