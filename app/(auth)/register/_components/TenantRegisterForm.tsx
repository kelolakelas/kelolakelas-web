    ...
    <div className="w-full rounded-2xl border border-gray-100 bg-white p-5 shadow-xl sm:p-8">
      <div className="mb-6 text-center sm:text-left">
        ...
        <p className="mt-1 text-xs text-gray-500 sm:text-sm">
          Set up a new organization/tenant and admin account
        </p>
      </div>
      ...
      <form action={formAction} noValidate className="space-y-4 sm:space-y-5">
        <div className="border-b border-gray-200 pb-4">
          <h3 className="mb-3 text-sm font-semibold text-gray-800">Organization Details</h3>
          <div className="space-y-4">
            <div>
              <label htmlFor="tenant_name" className="block text-xs font-medium text-gray-700 mb-1 sm:text-sm">
              ...
              />
              {state.errors?.tenant_name && (
                <p id="tenant_name-error" className="mt-1 text-xs text-red-600">
                  {state.errors.tenant_name[0]}
                </p>
              )}
            </div>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div>
                <label htmlFor="tenant_phone" className="block text-xs font-medium text-gray-700 mb-1 sm:text-sm">
                  Org Phone <span className="text-gray-400">(Optional)</span>
                </label>
                <input
                  id="tenant_phone"
                  name="tenant_phone"
              ...
              <div>
                <label htmlFor="tenant_address" className="block text-xs font-medium text-gray-700 mb-1 sm:text-sm">
                  Org Address <span className="text-gray-400">(Optional)</span>
                </label>
                <input
                  id="tenant_address"
                  name="tenant_address"
        ...
        <div>
          <h3 className="mb-3 text-sm font-semibold text-gray-800">Owner Account Details</h3>
          <div className="space-y-4 sm:space-y-5">
            ...
            <div>
              <label htmlFor="phone" className="block text-xs font-medium text-gray-700 mb-1 sm:text-sm">
                Owner Phone <span className="text-gray-400">(Optional)</span>
              </label>
              <input
                id="phone"
                name="phone"
